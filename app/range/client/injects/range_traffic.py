...
class range_traffic():
    def __init__(self):
        self.name = "Traffic Generator - Range"
        self.description = "This will create a random stream of traffic coming from the range."
    ...
    def range(self, **kwargs):
        ...
        cur_path = os.path.join(cur_path, 'client')
        cur_path = os.path.join(cur_path, 'injects')
